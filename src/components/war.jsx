...
import  BettingChipButton  from './bettingChipButton';
...
class War extends React.Component {
  ...
  renderCards() {
    ...
    let dealer1stCard = (dealer.getShowFirstCard()) ?
      <CardComponent src={require('../img/cards/'+ dealer.getFirstCard().getImageName())} location={{top: '0', left: '8%', right: '0', bottom: '60%'}} /> : null;
    let dealer2ndCard = (dealer.getShowSecondCard()) ?
      <CardComponent src={require('../img/cards/'+ dealer.getSecondCard().getImageName())} location={{top: '0', left: '13%', right: '0', bottom: '55%'}} /> : null;

    // populate 2nd Card when user decides to go to War
    let player1stCard = (player.getShowFirstCard()) ?
      <CardComponent src={require('../img/cards/'+ player.getFirstCard().getImageName())} location={{top: '35%', left: '30%', right: '0', bottom: '0'}} /> : null;
    let player2ndCard = (player.getShowSecondCard()) ?
      <CardComponent src={require('../img/cards/'+ player.getSecondCard().getImageName())} location={{top: '40%', left: '35%', right: '0', bottom: '0'}} /> : null;
  ...
  renderBettingChipButton()
  {
    return (
      <div className="bettingChipHolder">
        <BettingChipButton src={require('../img/chips/5top.png')} onClick={() => this.onClickBet(5)}/>
        <BettingChipButton src={require('../img/chips/10top.png')} onClick={() => this.onClickBet(10)}/>
        <BettingChipButton src={require('../img/chips/25top.png')} onClick={() => this.onClickBet(25)}/>
        <BettingChipButton src={require('../img/chips/100top.png')} onClick={() => this.onClickBet(100)}/>
      </div>
    )
  }
    ...
    return (
      <div>
        <BettingSlot
          ...
          top={{top: '23%'}}
          src={require("../img/table/Tie.png")}
          onClick={() => this.onSelectBettingSlot()} />
        <BettingSlot
          highlight={this.state.selectAnteSlot}
          top={{top: '55%'}}
          src={require("../img/table/Ante.png")}
          onClick={() => this.onSelectBettingSlot()} />
      </div>
    )
  }
